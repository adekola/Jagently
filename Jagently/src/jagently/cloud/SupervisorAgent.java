                ...
                try {
                    ...
                    switch (Message_Performative) {
                        case ACLMessage.REQUEST:
                            ...
                            try {
                                for (int i = globalAgentCount; i < (globalAgentCount + numberofAgents); i++) {
                                    AgentController t2 = home.createNewAgent(String.format("%s:%s", agentType, globalAgentCount++), PawnAgent.class.getCanonicalName(), args);
